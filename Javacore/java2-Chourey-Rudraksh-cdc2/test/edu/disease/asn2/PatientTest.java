...
public class PatientTest {
	...
	public void sortTest() {
		...
		Arrays.sort(dcm.getPets(),(s1,s2)->{return s2.compareTo(s1);});
		...
		Arrays.sort(dcm2.getPets(),(s1,s2)->{return s2.compareTo(s1);});
		assertEquals(dcm.getPets()[0].getFirstName()+dcm2.getPets()[0].getLastName(), dcm2.getPets()[0].getFirstName()+dcm2.getPets()[0].getLastName());
